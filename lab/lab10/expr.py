...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        child_env.update({para: arg for para, arg in zip(self.parameters, arguments)})
        # self.body is an instance of expression; it returns evaluated value after eval method call
